...
function doReportCall() {
    ...
    $.ajax({
        type: "POST",
        url: "ProjectReport105.aspx/RefreshGlobalReport105",
        data: params,
        contentType: "application/json; charset=utf-8",
        beforeSend: function (XMLHttpRequest) {
            $('#divGlobalReportHTML105').html("<h5 style='color:red;'>正在生成报表...</h5>");
        },
        success: function (msg) {
            $('#divGlobalReportHTML105').html("");
            if (msg.d) {
                $('#divGlobalReportHTML105').html(msg.d.toString());
            }
        },
