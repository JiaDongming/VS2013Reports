...
public partial class ProjectReport114 : Report
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            selProjectOptions114 = BindChoices(dataSet.Tables["DropDownFieldsChoice"]);  // 绑定下拉框字段值
        }
    }
    ...
    [WebMethod]
    public static string RefreshGlobalReport114(string selectedProjectsStr)
    {
        DBL db = new DBL();
        DataSet dataSet;
        ...
        return getChartReport(dataSet.Tables["ReportTable114"]);
    }
