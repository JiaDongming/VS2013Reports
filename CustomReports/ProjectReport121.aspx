<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectReport121.aspx.cs" ValidateRequest="false" Inherits="ProjectReport121" %>
                    ...
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem101">
                            <div class="globalReportItemHeader101">
                                <div class="globalHeaderLeft101">测试报表121</div>
                            ...
                            <div id="divGlobalReportHTML121"><%=htmlGlobalReportTable121%></div>
                        </div>
                    </td>               
                </tr>
            </table>
