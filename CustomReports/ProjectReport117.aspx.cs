...
public partial class ProjectReport117 : Report
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            selProjectOptions117 = BindChoices(dataSet.Tables["DropDownFieldsChoice"]);  // 绑定下拉框字段值
        }
    }
    ...
    [WebMethod]
    public static string RefreshGlobalReport117(string selectedProjectsStr)
    {
        DBL db = new DBL();
        DataSet dataSet;
        ...
        return getChartReport(dataSet.Tables["ReportTable117"]);
    }
