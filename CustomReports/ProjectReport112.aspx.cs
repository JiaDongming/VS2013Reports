...
public partial class ProjectReport112 : Report
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            selProjectOptions112 = BindChoices(dataSet.Tables["DropDownFieldsChoice"]);  // 绑定下拉框字段值
        }
    }
    ...
    [WebMethod]
    public static string RefreshGlobalReport112(string selectedProjectsStr)
    {
        DBL db = new DBL();
        DataSet dataSet;
        ...
        return getChartReport(dataSet.Tables["ReportTable112"]);
    }
