<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectReport105.aspx.cs" EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectReport105" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Script/GlobalReport105.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="projectReport_105">
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem105">
                            <div class="globalReportItemHeader105">
                                <div class="globalHeaderLeft105">设置</div>
                                <div class="globalHeaderMiddle105">&nbsp;</div>
                            </div>
                            <div>
                ...
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem105">
                            <div class="globalReportItemHeader105">
                                <div class="globalHeaderLeft105">测试报表5</div>
                                <div class="globalHeaderMiddle105">&nbsp;</div>
                            ...
                            <div id="divGlobalReportHTML105"><%=htmlGlobalReportTable105%></div>
                        </div>
                    </td>               
                </tr>
            </table>
